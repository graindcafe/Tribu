...
public class PathfinderGoalTrackPlayer extends PathfinderGoal {
	...
	public boolean b() {
		...
		// move stuff
		return target != null && //
				trueDebugMsg("testing navigation") && (!creature.getNavigation().g()) && //
	...
	@Override
	public void c() {
		// debugMsg("gonna add it ! " + ((CraftPlayer)
		// target.getBukkitEntity()).getDisplayName());
